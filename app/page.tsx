...
export default function Home() {
  ...
  // Dados mockados
  const mockCompanies = [
    { name: 'Nubank', location: 'São Paulo, SP', rating: 4.5, reviewCount: 127 },
    { name: 'IFPI', location: 'Teresina, PI', rating: 3.8, reviewCount: 45 },
    { name: 'Samsung', location: 'Campinas, SP', rating: 4.2, reviewCount: 89 },
    { name: 'Mercado Livre', location: 'São Paulo, SP', rating: 4.1, reviewCount: 203 },
  ...
  return (
    <div className="min-h-screen bg-[#F7F9FC]">
      ...
      <div 
        className="bg-[#2B2D31] rounded-b-[40px] shadow-xl h-[380px] relative overflow-hidden"
      >
        ...
        <div className="flex flex-col items-center justify-center px-4 pt-10 h-full relative z-10">
          <div className="w-full max-w-3xl flex flex-col items-center">
            ...
            {/* Nome do Produto */}
            <h1 className="font-sora text-4xl font-bold text-white mb-3">Job Reviewers</h1>
            
            {/* Subtítulo forte */}
            <p className="text-center text-white text-xl font-normal tracking-wide mb-8" style={{ opacity: 0.85 }}>
      ...
      <div className="px-4 py-12">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-[#0F172A] mb-6">Empresas recentes</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" style={{ filter: 'drop-shadow(0 2px 8px rgba(37, 99, 235, 0.08))' }}>
      ...
      <div 
        className="bg-[#2B2D31] py-16 px-4"
      >
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-white text-center mb-12">Garantias de Segurança</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 text-center transition-all hover:bg-white/15">
              ...
              <h3 className="font-sora text-xl font-semibold text-white mb-3">Anônimo</h3>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 text-center transition-all hover:bg-white/15">
              ...
              <h3 className="font-sora text-xl font-semibold text-white mb-3">Moderado</h3>
              <p className="text-white/80 text-sm leading-relaxed">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 text-center transition-all hover:bg-white/15">
              ...
              <h3 className="font-sora text-xl font-semibold text-white mb-3">Sem expor pessoas</h3>
              <p className="text-white/80 text-sm leading-relaxed">
                Nunca expomos dados pessoais de quem fez a review ou de pessoas citadas nas reviews.
              </p>
            </div>
          </div>
        </div>
